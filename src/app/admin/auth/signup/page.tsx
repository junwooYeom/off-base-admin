...
export default function AdminSignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Create admin record directly without Supabase Auth
      const response = await fetch('/api/admin/register', {
        ...
        body: JSON.stringify({ 
          email,
          password // We'll hash this on the server
        }),
      })
          ...
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                관리자 가입 요청이 접수되었습니다!
                <br />
                <strong className="text-gray-800">{email}</strong>로 가입 신청이 완료되었습니다.
                <br />
                <br />
        ...
        <CardContent>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              이미 계정이 있으신가요?{' '}
              <Link href="/admin/auth/login" className="text-blue-600 hover:text-blue-700">
                로그인
              </Link>
            </p>
          </div>
