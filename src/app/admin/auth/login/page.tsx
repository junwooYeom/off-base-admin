...
export default function AdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Login directly using our admin system
        ...
        <CardContent>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              관리자 계정이 없으신가요?{' '}
              <Link href="/admin/auth/signup" className="text-blue-600 hover:text-blue-700 font-medium">
                가입 신청
              </Link>
            </p>
          </div>
